--
-- Author: UHEVER
-- Date: 2015-03-23 17:18:09
--
local TodoListLayer = class("TodoListLayer", function (  )
	return display.newColorLayer(cc.c4b(10, 10, 10, 150))
end)

function TodoListLayer:ctor(  )
	-- 背景框
...
function TodoListLayer:initList(  )
	for i=1,10  do
